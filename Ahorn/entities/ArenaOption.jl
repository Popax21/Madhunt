...
@mapdef Entity "Madhunt/ArenaOption" ArenaOption(x::Integer, y::Integer, switchIDs::String="", arenaArea::String="", spawnLevel::String="", spawnIndex::Integer=0, initialSeekers::Integer=1, tagMode::Bool=true, goldenMode::Bool=false, hideNames::Bool=true)
